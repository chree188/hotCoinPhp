        ...
        <div class="model" style="display: none;" id="tradepass">
            <div class="model-body">
                ...
                <div class="model-form-body">
                    ...
                    <div class="model-form-item">
                        <button class="model-form-btn" id="modalbtn">{{__('market.submit')}}</button>
                    </div>
                </div>
            </div>
        </div>
...
<!--        <div class="container-fluid footer">
        ...
        @endif
        <script src="{{ asset('js/markt/HandleMarket.js') }}" type="text/javascript" charset="utf-8"></script>
        <script src="{{ asset('js/markt/trademarket2.js') }}" type="text/javascript" charset="utf-8"></script>
