                ...
                @include('layouts.userleftbar')
                    ...
                    <div class="col-xs-10 financial-data">
                        ...
                        <div class="col-xs-12 financial-data-nav">
                            <a href="{{route('loginlog')}}" class="left financial-data-navbar annal-data-navbar" >
                                <span style="width:90%">{{__('user.log-login')}}</span>
                            </a>
                            <a href="{{route('settinglog')}}" class="left financial-data-navbar annal-data-navbar active" >
                            ...
                            <div class="financial-table-box">
                                <table class="financial-table annal-tabel">
                                    <tr class="financial-table-header" >
                                        ...
                                        <th>{{__('user.log-security')}}</th>
                                        <th>{{__('user.log-loginIp')}}</th>
                                    </tr>
                                    <tbody class="financial-table-body" id="setting-data">
