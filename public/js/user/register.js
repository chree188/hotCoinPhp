...
$(function () {
    ...
    $(".btn-imgcode").on("click", function () {
        this.src = "/vailImg.html?r=" + new Date().getTime();
    });
    ...
    $(".btn-sendemailcode").on("click", function () {
        ...
        if (address == "") {
            util.layerTips($(this).data().tipsid, util.getLan('user.tips.6'));
            return;
        }
    ...
    $(".btn-sendphonecode").on("click", function () {
        ...
        var area = $.trim($("#form-site").attr('select-data'));
        if (phone == "") {
            util.layerTips($(this).data().tipsid, util.getLan('user.tips.phone'));
            return;
        }
        if (area == ""){
