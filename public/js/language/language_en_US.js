var language = {
    ...
    "user.tips.phone": " Please enter your phone! ",
    ...
    "consumer.index.1": "Order Number",
    "consumer.index.2": "Time",
    "consumer.index.3": "Remark",
    "consumer.index.4": "Type",
    "consumer.index.5": "Total(￥)",
    "consumer.index.6": "Amount",
    "consumer.index.7": "Status",
    "consumer.index.8": "Oper",
    "consumer.index.9": "Detail",

    "consumer.content.1":"min",
    "consumer.content.2":"buy",
    "consumer.content.3":"sell",
    "consumer.content.4":"The total selling price cannot be less than the minimum selling amount",
    "consumer.content.5":"Insufficient GSET available",
    "consumer.content.6":"The total purchase price should not be lower than the minimum purchase amount.",
    "consumer.content.7":"Please log in first",
    "consumer.content.8":"Your identity information is being reviewed in the background.",

    "consumer.type.1":"buy",
    "consumer.type.2":"sell",
    "consumer.type.3":"dealing",
    "consumer.type.4":"Completed",
    "consumer.type.5":"rescinded",
    "consumer.type.6":"closed",

    "consumer.notice.1":"Data loading failed",
    "consumer.notice.2":"You haven't added a bank card yet.",
    "consumer.notice.3":"password can not be empty",
    "consumer.notice.4":"The entered Google verification code cannot be empty",
    "consumer.notice.5":"The format of the input Google verification code is incorrect.",
    "consumer.notice.6":"Inconsistent password entered twice",
}